@extends('layout')
@section('content')
    @include('despachos.reparto.modals.mdl_bultos')
    @include('despachos.reparto.modals.mdl_reparto_show')
...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10 col-md-10">
        <h2 style="text-transform:uppercase"><b>LISTA DE REPARTO</b></h2>
        <ol class="breadcrumb">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="table-responsive">
                                ...
                                @include('despachos.reparto.tables.tbl_list_reparto')
...
<script>
    ...
    function iniciarDtRepartos() {
        ...
        dtRepartos = new DataTable('#tbl_list_reparto', {
            "serverSide": true,
            ...
            "ajax": {
                "url": "{{ route('despachos.reparto.getRepartos') }}",
                "type": "GET",
                "beforeSend": function() {
                    mostrarAnimacion();
                },
                    ...
                    render: function(data) {
                        ...
                        let acciones = `<div class='btn-group' style='text-transform:capitalize;'><button data-toggle='dropdown' class='btn btn-success btn-sm  dropdown-toggle'><i class='fa fa-bars'></i></button>
                                                        <ul class='dropdown-menu'>
                                                            <li><a class='dropdown-item' href='javascript:void(0);' onclick="openMdlRShow(${data.id})" title='Modificar' ><b><i class='fa fa-eye'></i> Detalle</a></b></li>
                                                       `;
