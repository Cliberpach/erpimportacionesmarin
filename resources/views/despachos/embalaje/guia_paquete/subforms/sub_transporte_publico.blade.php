<div class="row mb-3" id="divTransportista">
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2">
        ...
        <select required required name="vehiculo" required class="form-select select2_form" id="vehiculo"
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2">
        ...
        <select required required name="conductor" required class="form-select select2_form" id="conductor"
            data-placeholder="Seleccionar">
            <option></option>
            @foreach ($conductores as $conductor)
                <option value="{{ $conductor->id }}">
                    {{ $conductor->tipo_documento_nombre . ':' . $conductor->nro_documento . '-' . $conductor->nombre_completo }}
                </option>
            @endforeach
        </select>
