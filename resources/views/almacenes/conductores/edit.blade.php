...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
       <h2  style="text-transform:uppercase"><b>EDITAR CONDUCTOR</b></h2>
        <ol class="breadcrumb">
        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-content">
                    @include('almacenes.conductores.forms.form_edit_conductor')
                </div>
                <div class="ibox-footer d-flex justify-content-between align-items-center">
                    ...
                    <div style="display:flex;">
                        ...
                        <button class="btn btn-success" type="submit" form="formActualizarConductor">
...
<script>
    ...
    function events(){
        ...
        document.querySelector('#formActualizarConductor').addEventListener('submit',(e)=>{
            e.preventDefault();
            actualizarConductor();
        })
    ...
    function actualizarConductor(){
        ...
        title: "DESEA ACTUALIZAR EL CONDUCTOR?",
        ...
        if (result.isConfirmed) {
            ...
            const formActualizarConductor   =   document.querySelector('#formActualizarConductor');
            const formData                  =   new FormData(formActualizarConductor);
            let url                         =   `{{ route('almacenes.conductores.update', ['id' => ':id']) }}`;
            url                             =   url.replace(':id', id);

            Swal.fire({
                title: 'Cargando...',
                html: 'Actualizando conductor...',
            ...
            try {
                ...
                toastr.error(error,'ERROR EN LA PETICIÓN ACTUALIZAR CONDUCTOR');
                Swal.close();
            }
