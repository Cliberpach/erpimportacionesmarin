            ...
            <div class="row" id="formRegistrarContenido">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2">
                    ...
                    <select required name="tipo_documento" required class="form-select select2_form" id="tipo_documento"
                        ...
                        @foreach ($tipos_documento as $tipo_documento)
                            <option @if ($conductor->tipo_documento_id == $tipo_documento->id) selected @endif value="{{ $tipo_documento->id }}">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2">
                    ...
                    <div class="input-group mb-3">
                        <button class="btn btn-primary btn_consultar_documento" type="button"
                            id="button-addon1">
                            <i class="fa fa-search"></i>
                        </button>
                        <input
                        value="{{ $conductor->nro_documento }}"
                        required id="nro_documento" name="nro_documento" type="text"
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2">
                    ...
                    <div class="input-group">
                        ...
                        required id="nombres" maxlength="150" name="nombres" type="text"
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2" id="divApellido">
                    ...
                    <div class="input-group">
                        ...
                        required id="apellidos" maxlength="150" name="apellidos" type="text"
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2" id="divLicencia">
                    ...
                    <div class="input-group">
                        ...
                        minlength="9" maxlength="10" required id="licencia" name="licencia" type="text"
