    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                ...
                <form action="{{ route('ModeloExcel.marca') }}" method="get" style="display: inline-block;">
                    <input type="submit" class="btn btn-primary" value="Descargar el modelo de excel" />
                </form>
                <br>
                <span class="required">Nota: Si la marca esta agregada en el sistema, no se registrará de nuevo</span>
            </div>
...
@push('scripts')
    ...
    <script>
        var url = "{{ route('ImportExcel.uploadmarca') }}";
