<div class="modal inmodal" id="modal_editar_modelo" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                ...
                <small class="font-bold"  onkeyup="return mayus(this)">Modificar modelo.</small>
            </div>
            <div class="modal-body">
                <form role="form" action="{{route('almacenes.modelos.update')}}" method="POST" id="editar_modelo">
