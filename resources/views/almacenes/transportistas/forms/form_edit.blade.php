<form action="" id="formActualizarTransportista" method="post">
    <div class="row">
        @csrf
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2">
            ...
            <select required name="tipo_documento" required class="form-select select2_form" id="tipo_documento"
                ...
                @foreach ($tipos_documento as $tipo_documento)
                    <option @if ($tipo_documento->id == $transportista->tipo_documento_id) selected @endif value="{{ $tipo_documento->id }}">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2">
            ...
            <div class="input-group mb-3">
                <button id="btn_consultar_documento" class="btn btn-primary" type="button" id="button-addon1">
                    <i class="fa fa-search"></i>
                </button>
                <input maxlength="11" value="{{ $transportista->nro_documento }}" required id="nro_documento"
                    name="nro_documento" type="text" class="form-control" placeholder="N° DOCUMENTO"
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2">
            ...
            <div class="input-group mb-3">
                ...
                <input value="{{ $transportista->nombre }}" required id="nombre" maxlength="160" name="nombre"
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2 mb-3">
            ...
            <div class="input-group">
                ...
                <input value="{{ $transportista->direccion }}" maxlength="200" id="direccion" name="direccion"
                    type="text" class="form-control" placeholder="DIRECCIÓN FISCAL" aria-label="Username"
                    aria-describedby="basic-addon1">
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pb-2 mb-3">
            ...
            <div class="input-group">
                ...
                <input value="{{ $transportista->mtc }}" maxlength="20" id="mtc" name="mtc" type="text"
                    class="form-control" placeholder="MTC" aria-label="Username" aria-describedby="basic-addon1">
            </div>
            <span class="mtc_error msgError" style="color:red;"></span>
            <span style="color:rgb(0, 89, 255); font-style: italic;font-size:14px;">(SE PERMITE 20 CARACTERES COMO
                MÁXIMO, LETRAS MAYÚSCULAS Y NÚMEROS SIN ESPACIOS,SÍMBOLOS.)</span>
        </div>
