...
<script>
    ...
    function confirmarTraslado() {
        ...
        const mensaje = !traslado.venta_id ?
            "Se cambiará el estado a RECIBIDO y se ingresará stock en el almacén destino!" :
            "Se cambiará el estado a RECIBIDO, no se modificarán stocks.";

        const tituloLoading = !traslado.venta_id ?
            "Confirmando traslado y actualizando stocks..." :
            "Confirmando traslado interno...";
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                ...
                try {
                    ...
                    const res = await axios.post(route('almacenes.solicitud_traslado.confirmarStore'),
                        formData);
                    if (res.data.success) {
