...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10 col-md-10">
       <h2  style="text-transform:uppercase"><b>Modificar Vendedor</b></h2>
        <ol class="breadcrumb">
...
<div class="wrapper wrapper-content animated fadeIn">
    <form class="wizard-big" action="{{ route('mantenimiento.vendedor.update', $vendedor->id) }}" method="POST" enctype="multipart/form-data" id="form_modificar_vendedor">
        @csrf @method('PUT')
            ...
            <div class="row">
                <div class="form-group col-lg-4 col-xs-12" id="fecha_nacimiento">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="date" id="fecha_nacimiento" name="fecha_nacimiento" class="form-control {{ $errors->has('fecha_nacimiento') ? ' is-invalid' : '' }}" value="{{old('fecha_nacimiento', $vendedor->persona->fecha_nacimiento)}}" required >
                    </div>
                </div>
                <div class="form-group col-lg-4 col-xs-12">
        ...
        <fieldset style="position: relative;">
                ...
                <div class="form-group col-lg-4 col-xs-12">
                    ...
                    <select id="area" name="area" class="select2_form form-control {{ $errors->has('area') ? ' is-invalid' : '' }}" style="width: 100%">
                        ...
                        @foreach(areas() as $area)
                            <option value="{{ $area->simbolo }}" {{ (old('area', $vendedor->area) == $area->simbolo ? "selected" : "") }} >{{ $area->descripcion }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group col-lg-4 col-xs-12">
                    ...
                    <select id="profesion" name="profesion" class="select2_form form-control {{ $errors->has('profesion') ? ' is-invalid' : '' }}" style="width: 100%">
                        ...
                        @foreach(profesiones() as $profesion)
                            <option value="{{ $profesion->simbolo }}" {{ (old('profesion', $vendedor->profesion) == $profesion->simbolo ? "selected" : "") }} >{{ $profesion->descripcion }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group col-lg-4 col-xs-12">
                    ...
                    <select id="cargo" name="cargo" class="select2_form form-control {{ $errors->has('cargo') ? ' is-invalid' : '' }}" style="width: 100%">
                        ...
                        @foreach(cargos() as $cargo)
                            <option value="{{ $cargo->simbolo }}" {{ (old('cargo', $vendedor->cargo) == $cargo->simbolo ? "selected" : "") }} >{{ $cargo->descripcion }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-lg-4 col-xs-12">
                    ...
                    <input type="text" id="sueldo" name="sueldo" class="form-control {{ $errors->has('sueldo') ? ' is-invalid' : '' }}" value="{{old('sueldo', $vendedor->sueldo)}}" maxlength="15" onkeypress="return filterFloat(event,this);" required>
                </div>
                <div class="form-group col-lg-4 col-xs-12">
                    <label class="required">Sueldo bruto</label>
                    <input type="text" id="sueldo_bruto" name="sueldo_bruto" class="form-control {{ $errors->has('sueldo_bruto') ? ' is-invalid' : '' }}" value="{{old('sueldo_bruto', $vendedor->sueldo_bruto)}}" onkeypress="return filterFloat(event,this);" maxlength="15" required>
                </div>
                <div class="form-group col-lg-4 col-xs-12">
                    <label class="required">Sueldo neto</label>
                    <input type="text" id="sueldo_neto" name="sueldo_neto" class="form-control {{ $errors->has('sueldo_neto') ? ' is-invalid' : '' }}" value="{{old('sueldo_neto', $vendedor->sueldo_neto)}}" onkeypress="return filterFloat(event,this);" maxlength="15" required>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-lg-4 col-xs-12">
                    ...
                    <select id="moneda_sueldo" name="moneda_sueldo" class="select2_form form-control {{ $errors->has('moneda_sueldo') ? ' is-invalid' : '' }}" style="width: 100%">
                        ...
                        @foreach(tipos_moneda() as $moneda)
                            <option value="{{ $moneda->simbolo }}" {{ (old('moneda_sueldo', $vendedor->moneda_sueldo) == $moneda->simbolo ? "selected" : "") }}>{{ $moneda->descripcion }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group col-lg-4 col-xs-12">
                    ...
                    <select id="tipo_banco" name="tipo_banco" class="select2_form form-control {{ $errors->has('tipo_banco') ? ' is-invalid' : '' }}" style="width: 100%">
                        ...
                        @foreach(bancos() as $banco)
                            <option value="{{ $banco->simbolo }}" {{ (old('tipo_banco', $vendedor->tipo_banco) == $banco->simbolo ? "selected" : "") }} >{{ $banco->descripcion }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group col-lg-4 col-xs-12">
                    <label>Número de cuenta</label>
                    <input type="text" id="numero_cuenta" name="numero_cuenta" class="form-control {{ $errors->has('numero_cuenta') ? ' is-invalid' : '' }}" value="{{old('numero_cuenta', $vendedor->numero_cuenta)}}" maxlength="20" onkeypress="return isNumber(event)" onkeyup="return mayus(this)">
                </div>
            </div>
            <div class="row">
                <div class="form-group col-lg-4 col-xs-12">
                    ...
                    <select id="zona" name="zona" class="select2_form form-control {{ $errors->has('zona') ? ' is-invalid' : '' }}" >
                        ...
                        @foreach(zonas() as $zona)
                            <option value="{{ $zona->simbolo }}" {{ (old('zona', $vendedor->zona) == $zona->simbolo ? "selected" : "") }} >{{ $zona->descripcion }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group col-lg-4 col-xs-12">
                    <label class="required">Comisión</label>
                    <input type="text" id="comision" name="comision" class="form-control {{ $errors->has('comision') ? ' is-invalid' : '' }}" value="{{old('comision', $vendedor->comision)}}" onkeypress="return filterFloat(event,this);" maxlength="15" required>
                </div>
                <div class="form-group col-lg-4 col-xs-12">
                    ...
                    <select id="moneda_comision" name="moneda_comision" class="select2_form form-control {{ $errors->has('moneda_comision') ? ' is-invalid' : '' }}" >
                        <option></option>
                        @foreach(tipos_moneda() as $moneda)
                            <option value="{{ $moneda->simbolo }}" {{ (old('moneda_comision', $vendedor->moneda_comision) == $moneda->simbolo ? "selected" : "") }}>{{ $moneda->descripcion }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-lg-4 col-xs-12" id="fecha_inicio_actividad">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="date" id="fecha_inicio_actividad" name="fecha_inicio_actividad" class="form-control {{ $errors->has('fecha_inicio_actividad') ? ' is-invalid' : '' }}" value="{{old('fecha_inicio_actividad', $vendedor->fecha_inicio_actividad)}}" required >
                    </div>
                </div>
                <div class="form-group col-lg-4 col-xs-12" id="fecha_fin_actividad">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="date" id="fecha_fin_actividad" name="fecha_fin_actividad" class="form-control {{ $errors->has('fecha_fin_actividad') ? ' is-invalid' : '' }}" value="{{old('fecha_fin_actividad', (!empty($vendedor->fecha_fin_actividad)) ? $vendedor->fecha_fin_actividad : "")}}">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-lg-4 col-xs-12" id="fecha_inicio_planilla">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="date" id="fecha_inicio_planilla" name="fecha_inicio_planilla" class="form-control {{ $errors->has('fecha_inicio_planilla') ? ' is-invalid' : '' }}" value="{{old('fecha_inicio_planilla', (!empty($vendedor->fecha_inicio_planilla)) ? $vendedor->fecha_inicio_planilla : "")}}" >
                    </div>
                </div>
                <div class="form-group col-lg-4 col-xs-12" id="fecha_fin_planilla">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="date" id="fecha_fin_planilla" name="fecha_fin_planilla" class="form-control {{ $errors->has('fecha_fin_planilla') ? ' is-invalid' : '' }}" value="{{old('fecha_fin_planilla', (!empty($vendedor->fecha_fin_planilla)) ? $vendedor->fecha_fin_planilla : "")}}">
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-8 col-xs-12">
                    <div class="row">
                        <div class="form-group col-lg-6 col-xs-12">
                            ...
                            <input type="text" id="telefono_referencia" name="telefono_referencia" class="form-control {{ $errors->has('telefono_referencia') ? ' is-invalid' : '' }}" value="{{old('telefono_referencia', $vendedor->telefono_referencia)}}" maxlength="50" onkeyup="return mayus(this)">
                        </div>
                        <div class="form-group col-lg-6 col-xs-12">
                            <label>Contacto de referencia</label>
                            <input type="text" id="contacto_referencia" name="contacto_referencia" class="form-control {{ $errors->has('contacto_referencia') ? ' is-invalid' : '' }}" value="{{old('contacto_referencia', $vendedor->contacto_referencia)}}" maxlength="191" onkeyup="return mayus(this)">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-6 col-xs-12">
                            <label>Número de hijos</label>
                            <input type="text" id="numero_hijos" name="numero_hijos" class="form-control {{ $errors->has('numero_hijos') ? ' is-invalid' : '' }}" value="{{old('numero_hijos', $vendedor->numero_hijos)}}" onkeypress="return isNumber(event)" maxlength="2" >
                        </div>
                        <div class="form-group col-lg-6 col-xs-12">
                            ...
                            <select id="grupo_sanguineo" name="grupo_sanguineo" class="select2_form form-control {{ $errors->has('grupo_sanguineo') ? ' is-invalid' : '' }}" style="width: 100%">
                                ...
                                @foreach(grupos_sanguineos() as $grupo_sanguineo)
                                    <option value="{{ $grupo_sanguineo->simbolo }}" {{ (old('grupo_sanguineo', $vendedor->grupo_sanguineo) == $grupo_sanguineo->simbolo ? "selected" : "") }} >{{ $grupo_sanguineo->descripcion }} ({{ $grupo_sanguineo->simbolo }})</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-12 col-xs-12">
                            ...
                            <textarea type="text" id="alergias" name="alergias" class="form-control {{ $errors->has('alergias') ? ' is-invalid' : '' }}" value="{{old('alergias', $vendedor->alergias)}}" rows="3" onkeyup="return mayus(this)"></textarea>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <div class="custom-file">
                                    <input id="imagen" type="file" name="imagen" class="custom-file-input {{ $errors->has('imagen') ? ' is-invalid' : '' }}"  accept="image/*" src="{{ Storage::url($vendedor->ruta_imagen)}}">
                                    <label for="imagen" id="ruta_imagen" class="custom-file-label selected {{ $errors->has('ruta_imagen') ? ' is-invalid' : '' }}">
                                        @if($vendedor->nombre_imagen) {{$vendedor->nombre_imagen}} @else Seleccionar @endif
                                    </label>
                                ...
                                <div class="row justify-content-center">
                                    <p>
                                        @if($vendedor->ruta_imagen)
                                            <img class="logo" src="{{Storage::url($vendedor->ruta_imagen)}}" alt="">
                                            <input id="url_logo" name="url_logo" type="hidden" value="{{$vendedor->ruta_imagen}}">
                                        @else
