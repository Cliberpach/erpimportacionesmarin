<form role="form" action="{{ route('Caja.apertura') }}" method="POST" id="formAbrirCaja">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
            ...
            <select data-placeholder="SELECCIONAR" required name="caja" id="caja"
                class="select2_mdl_apertura_caja">
                <option></option>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
            ...
            <select required class="form-control select2_mdl_apertura_caja"
        ...
        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
            ...
            <input value="0" required type="text" class="form-control inputDecimalPositivo" id="saldo_inicial"
                name="saldo_inicial">
