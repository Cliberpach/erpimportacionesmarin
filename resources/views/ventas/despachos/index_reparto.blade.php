...
@section('despacho-active', 'active')
...
<script>
    ...
    function iniciarDtEmbalaje() {
        ...
        dtDespachos = new DataTable('#dataTables-despacho', {
            ...
            "ajax": {
                "url": "{{ route('ventas.despachos.getEmbalaje') }}",
                "type": "GET",
                "beforeSend": function() {
                    mostrarAnimacion();
                },
                    ...
                    render: function(data) {
                        ...
                        if (data.estado == "PENDIENTE" && (data.modo === "VENTA" || data.modo ===
                            ...
                            acciones += `<li class='dropdown-divider'></li>
                                            <li>
                                                <a class='dropdown-item' href='javascript:void(0);' onclick="embalar(${data.documento_id},${data.id})" title='Despachar' >
                                                    <b><i class="fa fa-dropbox"></i> Embalar
                                                </a>
                                            </li>
                                            <li>
                                                <a class='dropdown-item' href='javascript:void(0);' onclick="despachar(${data.documento_id},${data.id})" title='Despachar' >
                                                    <b><i class="fa fa-people-carry"></i> Despachar
                                                </a>
                                            </li>
                                            <li>
                                                <a class='dropdown-item' href='javascript:void(0);' onclick="openMdlEditarEnvio(${data.documento_id}, ${data.id})" title='Editar'>
