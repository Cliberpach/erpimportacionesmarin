<table style="margin:0 0 0 auto;">
    <tfoot>
        ...
        <tr>
            <td colspan="{{ count($tallas) + 5 }}" style="font-weight: bold;text-align:end;vertical-align:middle;">
                EMBALAJE:</td>
            <td class="td-embalaje" colspan="1" style="font-weight: bold;text-align:end;">
                <div class="input-group">
                    ...
                    <input style="width: 10px;" type="text" class="form-control embalaje" value="0"
                        aria-label="Username" aria-describedby="monto_embalaje">
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td class="td-envio" colspan="1" style="font-weight: bold;text-align:end;">
                <div class="input-group">
                    <span class="input-group-text btn-envio btn btn-light" id="monto-envio">
                        <i class="fas fa-truck"></i>
                    </span>
                    <input style="width: 70px;" type="text" class="form-control envio" value="0"
