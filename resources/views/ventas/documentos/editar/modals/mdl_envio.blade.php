        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="frmEnvio" class="formulario">
                        ...
                        <div class="col-12 col-md-12">
                            <div class="row justify-content-between">
                                ...
                                <div class="col-6 d-flex justify-content-end">
                                    <button onclick="borrarEnvio()" type="button" class="btn btn-danger btn-borrar-envio">BORRAR ENVÍO
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-3">
                            <label class="required" for="tipo_doc_destinatario" style="font-weight: bold;">TIPO DOCUMENTO</label>
                        ...
                        <div class="col-4">
                            <label class="required" for="nro_doc_destinatario" style="font-weight: bold;">Nro.
                        ...
                        <div class="col-5">
                            <label class="required" for="nombres_destinatario" style="font-weight: bold;">Nombres</label>
