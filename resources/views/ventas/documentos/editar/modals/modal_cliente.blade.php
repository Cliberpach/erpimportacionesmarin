                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div class="row">
                                <div class="col-12 col-md-6 mb-2">
                                    <div class="form-group m-0">
                                        <label class="required lbl_mdl_cliente" for="tipo_documento" style="font-weight: bold;">TIPO DE
                                            DOCUMENTO</label>
                                ...
                                <div class="col-12 col-md-6 mb-2">
                                    <div class="form-group m-0">
                                        <label class="required lbl_mdl_cliente" for="documento" style="font-weight: bold;">N° DOCUMENTO</label>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="required lbl_mdl_cliente" id="lblNombre" style="font-weight: bold;"
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label for="telefono_movil" class="required lbl_mdl_cliente" style="font-weight: bold;">TELÉFONO
                                            MÓVIL</label>
...
<script>
    ...
    function openModalCliente() {
        document.querySelector('#telefono_movil').value =   document.querySelector('#telefono').value;
