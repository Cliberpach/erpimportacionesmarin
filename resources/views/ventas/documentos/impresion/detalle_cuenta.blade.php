                ...
                @foreach ($detalles as $item)
                    <tr>
                        <td style="text-align: center; border-right: 2px solid #52BE80">
                            {{ getFechaFormato($item->fecha, 'd/m/Y') }}</td>
                    ...
                    <table class="tbl-total text-uppercase">
                        <tr>
                            ...
                            <td style="text-align:right; padding: 5px;">
                                <p class="p-0 m-0">{{ number_format($cuenta->saldo, 2) }}</p>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align:left; padding: 5px;">
                                <p class="p-0 m-0">Total cuenta: S/.</p>
                            </td>
                            <td style="text-align:right; padding: 5px;">
                                <p class="p-0 m-0">{{ number_format($cuenta->monto, 2) }}</p>
                            </td>
                        </tr>
                    </table>
                </td>
