    ...
    <tfoot>
        <tr>
          ...
          <td class="subtotal" colspan="1" style="font-weight: bold; text-align:end;">
            S/ {{ number_format($cotizacion->sub_total, 2, '.', ',') }}
          </td>
        </tr>
        <tr>
          ...
          <td class="td-embalaje" colspan="1" style="font-weight: bold; text-align:end;">
            <div class="input-group">
              ...
              <input readonly value="{{ number_format($cotizacion->monto_embalaje, 2, '.', ',') }}" style="width: 10px;" type="text" class="form-control embalaje">
            </div>
          </td>
        </tr>
        <tr>
          ...
          <td class="td-envio" colspan="1" style="font-weight: bold; text-align:end;">
            <div class="input-group">
              <span class="input-group-text btn btn-light btn-envio" id="monto-envio">
                <i class="fas fa-truck"></i>
              </span>
              <input readonly value="{{ number_format($cotizacion->monto_envio, 2, '.', ',') }}" style="width: 70px;" type="text" class="form-control envio">
            </div>
          </td>
        </tr>
        <tr>
          ...
          <td class="descuento" colspan="1" style="font-weight: bold; text-align:end;">
            S/ {{ number_format($cotizacion->monto_descuento, 2, '.', ',') }}
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="igv" colspan="1" style="font-weight: bold; text-align:end;">
            S/ {{ number_format($cotizacion->total_igv, 2, '.', ',') }}
          </td>
        </tr>
        <tr>
          ...
          <td class="total-pagar" colspan="1" style="font-weight: bold; text-align:end;">
            S/ {{ number_format($cotizacion->total_pagar, 2, '.', ',') }}
          </td>
        </tr>
      </tfoot>
</table>
