    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                ...
                <form action="{{ route('ModeloExcel.proveedor') }}" method="get" style="display: inline-block;">
...
@push('scripts')
    ...
    <script>
        var url = "{{ route('ImportExcel.uploadproveedor') }}";
        ...
        uppy.on('upload-success', (file, response) => {
            ...
            if (resultado.length == 0) {
                ...
                let fila = {
                    excel: resultado[resultado.length - 1].excel
                };
                dataE.push(fila);
