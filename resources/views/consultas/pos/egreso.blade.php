...
@section('pos_egreso-active', 'active')

<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10 col-md-8">
       <h2  style="text-transform:uppercase"><b>Egreso</b></h2>
        <ol class="breadcrumb">
            ...
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table class="table dataTables-consulta table-striped table-bordered table-hover"
...
<script>
     $(document).ready(function() {
        ...
        tablaDatos = $('.dataTables-consulta').DataTable({
            "language": {
        ...
        $ ('.dataTables-consulta'). on ('dblclick', 'tbody td', function () {
    ...
    function loadTable(caja_id,fecha_ini,fecha_fin, cuenta_id)
    {
        ...
        $(".dataTables-consulta").dataTable().fnDestroy();
        $('.dataTables-consulta').DataTable({
            "dom":
            ...
            'bAutoWidth': false,
            "ajax": {
                "url": "{{route('consultas.pos.egreso.getTable')}}",
                "type": "POST",
