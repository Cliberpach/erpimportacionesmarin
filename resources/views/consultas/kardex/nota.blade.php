...
@section('salida-notas-active', 'active')
...
$(document).ready(function() {
    ...
    tablaDatos = $('.dataTables-notas').DataTable();
        ...
        Swal.fire({
            ...
            didOpen: () => {
                ...
                $.ajax({
                    dataType : 'json',
                    type : 'post',
                    url : '{{ route('consultas.kardex.notas.getTable') }}',
...
function loadTable()
{
    ...
    $('.dataTables-notas').DataTable({
        ...
        "columns": [ 
            ...
            {data: 'motivo', name:'motivo', className: "text-center letrapequeña"},
