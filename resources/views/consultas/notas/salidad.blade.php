...
@section('nota_salida_consulta-active', 'active')
            ...
            <div class="ibox ">
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table class="table dataTables-salidad_mercaderia table-striped table-bordered table-hover"
...
$(document).ready(function() {
    ...
    tablaDatos = $('.dataTables-salidad_mercaderia').DataTable();
        ...
        Swal.fire({
            ...
            didOpen: () => {
                ...
                $.ajax({
                    dataType : 'json',
                    type : 'post',
                    url : '{{ route('consultas.notas.salidad.getTable') }}',
...
function loadTable()
{
    $('.dataTables-salidad_mercaderia').dataTable().fnDestroy();
    $('.dataTables-salidad_mercaderia').DataTable({
