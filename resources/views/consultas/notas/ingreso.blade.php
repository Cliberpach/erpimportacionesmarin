...
@section('nota_ingreso_consulta-active', 'active')
...
$(document).ready(function() {
    ...
    tablaDatos = $('.dataTables-ingreso_mercaderia').DataTable();
        ...
        Swal.fire({
            ...
            didOpen: () => {
                ...
                $.ajax({
                    dataType : 'json',
                    type : 'post',
                    url : '{{ route('consultas.notas.ingreso.getTable') }}',
...
function loadTable()
{
    $('.dataTables-ingreso_mercaderia').dataTable().fnDestroy();
