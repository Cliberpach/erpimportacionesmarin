...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10 col-md-10">
       <h2  style="text-transform:uppercase"><b>{{$title}}</b></h2>
        <ol class="breadcrumb">
        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-content">
                    <form action="{{ $action }}" enctype="multipart/form-data"  method="POST" id="crear_rol">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6 col-xs-12 b-r">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-6 col-xs-12">
                                        ...
                                        <input type="text" id="name" name="name" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }} text-uppercase" value="{{old('name')? old('name') : $role->name}}" maxlength="50" required>
                                        @if ($errors->has('name'))
                                    ...
                                    <div class="col-lg-6 col-xs-12">
                                        ...
                                        <input type="text" id="slug" class="form-control {{ $errors->has('slug') ? ' is-invalid' : '' }} text-uppercase" name="slug" value="{{old('slug')? old('slug') : $role->slug}}">
                                        @if ($errors->has('slug'))
                                            <span class="invalid-feedback" role="alert">
