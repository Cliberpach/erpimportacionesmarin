<table style="margin:0 0 0 auto;">
    <tfoot>
        ...
        <tr>
            <td colspan="{{ count($tallas) * 2 + 3 }}" style="font-weight: bold;text-align:end;vertical-align:middle;">
                EMBALAJE:</td>
            <td class="td-embalaje" colspan="1" style="font-weight: bold;text-align:end;">
                <div class="input-group">
                    ...
                    <input disabled style="width: 80px;" type="text" class="form-control embalaje" value="0"
        ...
        <tr>
            ...
            <td class="td-envio" colspan="1" style="font-weight: bold;text-align:end;">
                <div class="input-group">
                    ...
                    <input disabled style="width: 80px;" type="text" class="form-control envio" value="0"
